...
class SeasonStrategy:
    ...
    def remaining_days(self) -> int:
        ...
        return self.SEASON_LENGTH - self.day
    ...
    def should_invest(self) -> bool:
        ...
        return self.phase() in ("EARLY", "MID")

    def should_sell_all(self) -> bool:
        """Return True during the final days of the season."""
        return self.phase() == "END"

    def can_plant(self, growth_days: int) -> bool:
        """
        Return True if a crop can mature before the season ends.
        """
